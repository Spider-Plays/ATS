...
export const api = {
    ...
    portal: {
        ...
        getOffer: portalService.getOffer,
        acceptOffer: portalService.acceptOffer,
    ...
    offers: {
        ...
        getPending: offerService.getPending,
        previewCompensation: offerService.previewCompensation,
        getLetterHtml: offerService.getLetterHtml,
        downloadLetterPdf: offerService.downloadLetterPdf,
        ...
        negotiate: offerService.negotiate,
