...
const VendorJobSubmit = () => {
  ...
  return (
    <CandidateSubmissionWizard
      ...
      subtitle="Upload a resume and complete the profile fields for this role."
      backHref={`/vendor-portal/positions/${id}`}
...
export default VendorJobSubmit;
